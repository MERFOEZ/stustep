...
class QuestCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ratio = progress?.progressRatio ?? (targetCount > 0 ? (currentCount / targetCount).clamp(0.0, 1.0) : 0.0);
              ...
              children: [
                Expanded(
                  child: QuestProgressBar(
                    progressRatio: ratio,
                    progressColor: isCompleted ? const Color(0xFF00C853) : sectionColor,
                    height: 8,
                  ),
                ),
                const SizedBox(width: 12),
